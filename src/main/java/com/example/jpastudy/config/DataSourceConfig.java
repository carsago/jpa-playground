...
import static com.example.jpastudy.config.DataSourceType.Key.REPLICA_NAME;
import static com.example.jpastudy.config.DataSourceType.Key.ROUTING_NAME;
import static com.example.jpastudy.config.DataSourceType.Key.SOURCE_NAME;
